Shader "Hidden/Locked/.poiyomi/Poiyomi 8.2/Poiyomi Pro World/4516cee835ce1b74689dc0f08c5d51af"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			)
			{
				...
				float3 heightOffset = (tex2Dlod(_VertexManipulationHeightMask, float4(poiUV(vertexUV(v, (0.0 /*_VertexManipulationHeightMaskUV*/)), float4(1,1,0,0)) + float4(0,0,0,0) * _Time.x, 0, 0))[(0.0 /*_VertexManipulationHeightMaskChannel*/)] - (0.0 /*_VertexManipulationHeightBias*/)) * ((0.01 /*_VertexManipulationHeight*/) + ALHeight) * o.normal;
				#else
				float3 heightOffset = ((0.01 /*_VertexManipulationHeight*/) + ALHeight) * o.normal;
				#endif
			...
			void calculateShading(inout PoiLight poiLight, inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam)
			{
				...
				{
					lns.x = poiEdgeNonLinearNoSaturate(lightMap.x, (0.5 /*_ShadowBorder*/), (0.106 /*_ShadowBlur*/) * blurMap.r);
					...
					lns.w = poiEdgeNonLinearNoSaturate(lightMap.x, (0.5 /*_ShadowBorder*/), (0.106 /*_ShadowBlur*/) * blurMap.r, (0.0 /*_ShadowBorderRange*/));
				}
				else
				{
					lns.x = poiEdgeLinearNoSaturate(lightMap.x, (0.5 /*_ShadowBorder*/), (0.106 /*_ShadowBlur*/) * blurMap.r);
					...
					lns.w = poiEdgeLinearNoSaturate(lightMap.x, (0.5 /*_ShadowBorder*/), (0.106 /*_ShadowBlur*/) * blurMap.r, (0.0 /*_ShadowBorderRange*/));
				}
				lns = saturate(lns);
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				poiLight.lightMap = 1;
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(1,1,1,0.05490196).rgb, (0.0 /*_ColorThemeIndex*/));
