Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Pro/d418699fed8458248bacdd8cc76993fc"
{
	Properties
	{
...
#define PROPM_END_STENCILPASSOPTIONS 0
			...
			void ApplyAlphaToCoverage(inout PoiFragData poiFragData, in PoiMesh poiMesh)
			{
				...
				if (float(0) == 1)
				{
					...
					if (float(0) && float(0))
					{
						poiFragData.alpha *= 1 + max(0, CalcMipLevel(poiMesh.uv[0] * float4(0.0078125,0.03125,128,32).zw)) * float(0.25);
