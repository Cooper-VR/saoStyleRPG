Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Pro/c0181cf820b344d469ca84be98cab1df"
{
	Properties
	{
...
#define PROP_MATCAPREPLACE 0.34
#define PROP_MATCAPMULTIPLY 0
#define PROP_MATCAPADD 0.329
...
#define PROP_CLEARCOATSTRENGTH 0.694
...
#define PROPM_END_STENCILPASSOPTIONS 0
			...
			void applyMatcap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, inout PoiLight poiLight, in PoiMods poiMods)
			{
				...
				blendMatcap(poiLight, poiFragData, float(0.329), float(0), float(0), float(0.34), float(0), matcap, matcapMask, float(0), float(0)
				#ifdef POI_BLACKLIGHT
			...
			{
				float clearCoatMask = float(0.694);
			...
			float4 frag(v2f i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				float3 mainNormal = UnpackScaleNormal(POI2D_SAMPLER_PAN(_BumpMap, _MainTex, poiUV(poiMesh.uv[float(0)], float4(1,1,0,0)), float4(0,0,0,0)), float(1.04));
