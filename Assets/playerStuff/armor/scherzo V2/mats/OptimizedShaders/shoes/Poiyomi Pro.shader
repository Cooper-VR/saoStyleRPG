Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Pro/08a7ef6d94566064e86ed6cbbbd69999"
{
	Properties
	{
...
#define PROPM_END_STENCILPASSOPTIONS 0
			...
			float4 frag(v2f i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				float3 mainNormal = UnpackScaleNormal(POI2D_SAMPLER_PAN(_BumpMap, _MainTex, poiUV(poiMesh.uv[float(1)], float4(1,1,0,0)), float4(0,0,0,0)), float(1));
