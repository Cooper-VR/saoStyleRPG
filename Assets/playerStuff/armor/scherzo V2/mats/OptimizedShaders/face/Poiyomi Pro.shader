Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Pro/26d94cfcde46fb64bbedd51a70cd8d8b"
{
	Properties
	{
...
#define PROP_DETAILTEXINTENSITY 2.23
...
#define PROP_ANISOUSEBASECOLOR 0.482
...
#define PROP_ANISO1POWER 1
#define PROP_ANISO1STRENGTH 1
#define PROP_ANISO1OFFSET 0.29
#define PROP_ANISO1OFFSETMAPSTRENGTH 0.314
...
#define PROP_DISSOLVEEDGEEMISSION 6.7
...
#define PROP_CONTINUOUSDISSOLVE 3.96
...
#define PROP_PATHTYPER 2
#define PROP_PATHTYPEG 2
#define PROP_PATHTYPEB 2
#define PROP_PATHTYPEA 2
...
#define PROP_DEPTHCOLORTOGGLE 1
...
#define PROP_TEXTFPSEMISSIONSTRENGTH 6.2
...
#define PROPM_MODIFIERCATEGORY 1
#define PROPM_START_UVDISTORTION 1
...
#define PROP_DISTORTIONSTRENGTH -1.35
...
#define PROPM_END_STENCILPASSOPTIONS 0
			...
			void ApplyAlphaToCoverage(inout PoiFragData poiFragData, in PoiMesh poiMesh)
			{
				...
				if (float(0) == 1)
				{
					...
					if (float(0) && float(0))
					{
						poiFragData.alpha *= 1 + max(0, CalcMipLevel(poiMesh.uv[0] * float4(0.001953125,0.001953125,512,512).zw)) * float(0.25);
