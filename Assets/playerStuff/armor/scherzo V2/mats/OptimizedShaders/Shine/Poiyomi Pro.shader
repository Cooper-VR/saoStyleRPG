Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Pro/fb07ee71f16bfbe458d39e90d0ef50ad"
{
	Properties
	{
...
#define PROPM_END_STENCILPASSOPTIONS 0
			...
			void ApplyAlphaToCoverage(inout PoiFragData poiFragData, in PoiMesh poiMesh)
			{
				...
				if (float(1) == 1)
				{
					...
					if (float(0) && float(0))
					{
						poiFragData.alpha *= 1 + max(0, CalcMipLevel(poiMesh.uv[0] * float4(0.0078125,0.0078125,128,128).zw)) * float(0.25);
