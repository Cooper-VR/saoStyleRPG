Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Pro/d2b77b5fe84b5474d898e1254fc5dc79"
{
	Properties
	{
...
#define PROP_MATCAPREPLACE 0.225
#define PROP_MATCAPMULTIPLY 0.118
...
#define PROP_RIMWIDTH 0.708
#define PROP_RIMSHARPNESS 0.313
...
#define PROPM_END_STENCILPASSOPTIONS 0
			...
			void applyMatcap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, inout PoiLight poiLight, in PoiMods poiMods)
			{
				...
				blendMatcap(poiLight, poiFragData, float(0), float(0), float(0.118), float(0.225), float(0), matcap, matcapMask, float(0), float(0)
				#ifdef POI_BLACKLIGHT
			...
			void ApplyRimLighting(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, in PoiLight poiLight, in PoiMods poiMods)
			{
				...
				float rimWidth = lerp( - .05, 1, float(0.708));
				...
				float rim = 1 - smoothstep(min(float(0.313), rimWidth), rimWidth, viewDotNormal);
