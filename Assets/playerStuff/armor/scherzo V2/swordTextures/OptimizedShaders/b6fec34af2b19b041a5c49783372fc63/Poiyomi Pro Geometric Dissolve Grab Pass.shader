Shader "Hidden/Locked/.poiyomi/Poiyomi 8.2/Poiyomi Pro Geometric Dissolve Grab Pass/b6fec34af2b19b041a5c49783372fc63"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void GeometryProgram(triangle VertexOut p[3], inout TriangleStream<VertexOut> triStream)
			{
				...
				float geoDissolveAlpha = (1.0 /*_GeoDissolveAlpha*/);
				if ((1.0 /*_GeoDissolveGradientType*/) == GEO_DISSOLVE_TEXTURE)
				{
				...
				else if ((1.0 /*_GeoDissolveGradientType*/) == GEO_DISSOLVE_P2P)
				{
					geoDissolveAlpha = remapClamped(-1, 1, geoDissolveAlpha, -1 - (0.454 /*_GeoDissolveExpansionTime*/), (0.454 /*_GeoDissolveExpansionTime*/));
				...
				else if ((1.0 /*_GeoDissolveGradientType*/) == GEO_DISSOLVE_NOISE)
				{
					...
					geoDissolveAlpha = remap(geoDissolveAlpha, (0.646 /*_GeoDissolveNoiseThreshold*/) - (1 - (0.646 /*_GeoDissolveNoiseThreshold*/)), 1, -1 + (saturate((1.0 /*_GeoDissolveAlpha*/)) * 2), 1 - (saturate(-1 * (1.0 /*_GeoDissolveAlpha*/)) * 2));
				}
			...
			void poiGeometricDissolve(float4 geoDissolveAlpha, inout PoiFragData poiFragData, in PoiMesh poiMesh, inout PoiMods poiMods, in PoiCam poiCam)
			{
				...
				if ((0.0 /*_GeoDissolvePointToPointDebug*/) && (1.0 /*_GeoDissolveGradientType*/) == GEO_DISSOLVE_P2P)
				{
			...
			float4 grabpassBlur(float2 uv)
			{
				...
				float2 radius = (0.0 /*_GrabBlurDistance*/) / _ScreenParams.xy * 100; // Arbitrary constant to match old blurring
				float quality = floor((2.0 /*_GrabBlurQuality*/));
				float directions = floor((4.0 /*_GrabBlurDirections*/));
			...
			void calculateGrabpass(float2 projectedGrabPos, inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, inout PoiLight poiLight, in PoiMods poiMods)
			{
				...
				if ((0.0 /*_RefractionEnabled*/) == 1)
				{
					grabpassColor = Refraction((1.333333 /*_RefractionIndex*/), (0.0 /*_RefractionChromaticAberattion*/), projectedGrabPos, poiMesh, poiCam, poiMods).rgb;
				}
				else
				{
				...
				poiFragData.finalColor = poiBlend((0.0 /*_GrabSrcBlend*/), float4(poiFragData.finalColor, poiFragData.alpha), (2.0 /*_GrabDstBlend*/), float4(grabpassColor, 1), blendFactor);
			}
			...
			void calculateShading(inout PoiLight poiLight, inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam)
			{
				...
				#endif
				#ifdef _LIGHTINGMODE_TEXTURERAMP
				poiLight.rampedLightMap = lerp(1, UNITY_SAMPLE_TEX2D(_ToonRamp, poiLight.lightMap + (-0.31 /*_ShadowOffset*/)).rgb, shadowStrength);
			...
			void applyMatcap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, inout PoiLight poiLight, in PoiMods poiMods)
			{
				...
				blendMatcap(poiLight, poiFragData, poiMods, (0.903 /*_MatcapAdd*/), (0.0 /*_MatcapAddToLight*/), (0.598 /*_MatcapMultiply*/), (0.254 /*_MatcapReplace*/), (0.079 /*_MatcapMixed*/), (0.0 /*_MatcapScreen*/), matcap, matcapMask, (0.0 /*_MatcapEmissionStrength*/), (0.0 /*_MatcapLightMask*/), (0.0 /*_MatcapMaskGlobalMask*/), (2.0 /*_MatcapMaskGlobalMaskBlendType*/));
				#endif
			}
			#endif
