Shader "Hidden/Locked/.poiyomi/Poiyomi 8.2/Poiyomi Pro/1ba0b066c70d09045a047544d105790d"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyMatcap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, inout PoiLight poiLight, in PoiMods poiMods)
			{
				...
				blendMatcap(poiLight, poiFragData, poiMods, (0.903 /*_MatcapAdd*/), (0.0 /*_MatcapAddToLight*/), (0.086 /*_MatcapMultiply*/), (0.254 /*_MatcapReplace*/), (0.079 /*_MatcapMixed*/), (0.0 /*_MatcapScreen*/), matcap, matcapMask, (0.0 /*_MatcapEmissionStrength*/), (0.0 /*_MatcapLightMask*/), (0.0 /*_MatcapMaskGlobalMask*/), (2.0 /*_MatcapMaskGlobalMaskBlendType*/));
				#endif
			}
			#endif
